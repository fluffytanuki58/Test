...
import chaiTea from "../assets/chai.gif";
...
export default function Lounge() {
  return (
    <>
      <p>
        <img src={logo} alt="Head First Lounge" />
      </p>
      ...
      <p>
        ...
        sentiments of sights from eras past. And, don't forget, the lounge
        offers free wireless access to the Internet, so bring your laptop.
      </p>

      <p id="guarantee">
        Our guarantee: at the lounge, we're committed to providing you, our
        guest, with an exceptional experience every time you visit. Whether
        you're just stopping by to check in on email over an elixir, or are here
        for an out-of-the-ordinary dinner, you'll find our knowledgeable service
        staff pay attention to every detail. If you're not fully satisfied, have
      ...
      <p>
        ...
        from the main lounge right to the dance floor. If you've had enough of
        the beat, just head back to the lounge area to relax. And, no matter
        where you find yourself in the lounge, you'll always be connected with
      ...
      <p>
        ...
        <HashLink
          to="about/directions"
          title="Detailed Directions to the Lounge"
        >
          detailed directions
        </HashLink>
        &nbsp;to get you here in record time. No reservations necessary; come
        and join us anytime.
      </p>
      <div id="elixirs">
        <h2>Weekly Elixir Specials</h2>
        <p>
          <img src={yellow} alt="Lemon Breeze Elixir" />
        </p>
        <h3>Lemon Breeze</h3>
        <p>
          The ultimate healthy drink, this elixir combines herbal botanicals,
          minerals, and vitamins with a twist of lemon into a smooth citrus
          wonder that will keep your immune system going all day and all night.
        </p>

        <p>
          <img src={chaiTea} alt="Chai Chiller Elixir" />
        </p>
        <h3>Chai Chiller</h3>
        <p>
        ...
        <p>
          <img src={black} alt="Black Brain Brew Elixir" />
        </p>
        <h3>Black Brain Brew</h3>
        <p>
          Want to boost your memory? Try our Black Brain Brew elixir, made with
          black oolong tea and just a touch of espresso. Your brain will thank
          you for the boost.
        </p>

        <p>
          Join us any evening for these and all our other wonderful&nbsp;
          <HashLink to="beverages/elixir" title="Head First Lounge Elixirs">
            elixirs
          </HashLink>
          .
        </p>
      ...
      <div id="music">
        ...
        <p>
          ...
          wonder, it's great stuff. Just for you, we keep a list here on the
          site, updated weekly. Enjoy.
        </p>
        <ul>
          <li>
            <span class="cdtitle">Buddha Bar</span>,{" "}
            <span class="artist">Claude Challe</span>
          </li>
          <li>
            <span class="cdtitle">When It Falls</span>,{" "}
            <span class="artist">Zero 7</span>
          </li>
          <li>
            <span class="cdtitle">Earth 7</span>,{" "}
            <span class="artist">L.T.J. Bukem</span>
          </li>
          <li>
            <span class="cdtitle">Le Roi Est Mort, Vive Le Roi!</span>,{" "}
            <span class="artist">Enigma</span>
          </li>
          <li>
            <span class="cdtitle">Music for Airports</span>,{" "}
